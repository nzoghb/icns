...
import TextBubbleDefault from "../icons/TextBubble";
import QuestionMarkDefault from "../icons/QuestionMark";
// import HowToUseDefault from '../components/HowToUse/HowToUse'
// import Alice from '../components/HomePage/Alice'
import ENSLogo from "../../assets/logo.svg";
...
export default ({ match }) => {
  ...
  //   const { accounts, network, loading, refetch, isReadOnly, isSafeApp } =
  //     useNetworkInfo();
